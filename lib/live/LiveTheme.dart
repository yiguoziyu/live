...
class LiveStyle extends TextStyle {
  LiveStyle.roboto(double size, FontWeight weight, Color color)
      : super(
            inherit: false,
            color: color,
            fontSize: size,
  ...
  LiveStyle.abrilFatface(double size, FontWeight weight, Color color)
      : super(
            inherit: false,
            color: color,
...
TextStyle robotoRegular12(Color color) =>
    new LiveStyle.roboto(12.0, FontWeight.w500, color);

TextStyle robotoLight12(Color color) =>
    new LiveStyle.roboto(12.0, FontWeight.w300, color);

TextStyle robotoRegular14(Color color) =>
    new LiveStyle.roboto(14.0, FontWeight.w500, color);

TextStyle robotoMedium14(Color color) =>
    new LiveStyle.roboto(14.0, FontWeight.w600, color);

TextStyle robotoLight14(Color color) =>
    new LiveStyle.roboto(14.0, FontWeight.w300, color);

TextStyle robotoRegular16(Color color) =>
    new LiveStyle.roboto(16.0, FontWeight.w500, color);

TextStyle robotoRegular20(Color color) =>
    new LiveStyle.roboto(20.0, FontWeight.w500, color);

TextStyle abrilFatfaceRegular24(Color color) =>
    new LiveStyle.abrilFatface(24.0, FontWeight.w500, color);

TextStyle abrilFatfaceRegular34(Color color) =>
    new LiveStyle.abrilFatface(34.0, FontWeight.w500, color);

///主题定制
class LiveTheme extends InheritedWidget {
  ...
  static LiveTheme of(BuildContext context) =>
      context.inheritFromWidgetOfExactType(LiveTheme);
